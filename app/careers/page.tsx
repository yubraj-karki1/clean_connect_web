  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-12 text-slate-900 dark:bg-slate-950 dark:text-slate-100 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-4xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <p className="mt-4 text-slate-600 dark:text-slate-300">We are always looking for talented people in engineering, operations, and customer support.</p>
        <p className="mt-2 text-slate-600 dark:text-slate-300">Send your CV and portfolio to careers@cleanconnect.com.</p>
        <div className="mt-8">
